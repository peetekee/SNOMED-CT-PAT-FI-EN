...
if st.session_state.cs_format_processing_started:
    ...
    main_process = CSFormat(st.session_state.password) # Ensure this uses updated environment variables if needed
    ...
    st.session_state.update(cs_format_processing_started=False, cs_format_processing_completed=True)
